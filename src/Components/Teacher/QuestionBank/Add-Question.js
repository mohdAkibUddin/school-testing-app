...
class AddQuestion extends React.Component {
  ...
  async postData(data) {
    await axios
      .post("https://w81a61.deta.dev/question", data, {
        headers: {
        ...
        <div key={"difficulty" + difficulty}>
          <label htmlFor={difficulty}>
            <input
              ...
              disabled={
                this.state.checkbox_disabled["difficulty"] !== null &&
                this.state.checkbox_disabled["difficulty"] !== difficulty
              }
            />
            {difficulty}
          </label>
        ...
        <div key={"constraint" + constraint}>
          <label htmlFor={constraint}>
            <input
              ...
              onChange={this.handleCheckbox}
              disabled={
                this.state.checkbox_disabled["constraint"] !== null &&
                this.state.checkbox_disabled["constraint"] !== constraint
              }
            />
            {constraint}
          </label>
    ...
    return (
      <div className="outline">
        ...
        <form onSubmit={this.handleSubmit}>
          <label>
            <p className="questionDetails">Question:</p>
            <textarea
              name="question"
              cols="30"
              rows="10"
            ...
            />
            <p className="questionDetails">Function Name:</p>
            <input
              type="text"
              name="function_name"
              ...
              onChange={this.handleChange}
            />
            <p className="questionDetails">Input Type(s) (Space Seperated)</p>
            <input
              type="text"
              name="types_input"
            ...
            />
            <p className="questionDetails">Output Type(s) (Space Seperated)</p>
            <input
              type="text"
              name="types_output"
              ...
              onChange={this.handleChangeTypes}
            />
            <p className="questionDetails">Testcase(s) Space Seperated</p>
            {testcaseBoxes}
            <input
              type="button"
              value="Add Case"
              onClick={this.addBox}
              hidden={this.state.testcaseCount === 5}
            />
            <br />
            <p>Difficulty</p>
          ...
          <br />
          <br />
          <input className="gradeTestsButton" type="submit" />
        </form>
      </div>
    );
  }
